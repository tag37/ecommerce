<%@ Page Language="C#" MasterPageFile="~/view/BigKisanMaster.Master" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="admin_BigKisan.view.category.Category" %>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList runat="server" type="text" class="form-control" ID="ddlParentCategory" DataTextField="value" DataValueField="key">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtCategory" placeholder="Enter Category">
                            </div>
                            <div class="form-group" align="right">
                                ...
                                <asp:LinkButton runat="server" ID="btnReset" CssClass="btn btn-warning"><i class="fa fa-times"></i>&nbsp;Cancel</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-header with-border">
                    <h3 class="box-title">Existing Suppliers</h3>
                </div>
                <div class="box box-primary">
                    <div class="box-body">
