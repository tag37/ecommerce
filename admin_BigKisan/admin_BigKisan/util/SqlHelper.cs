...
namespace admin_BigKisan.util
{
    public static class SqlHelper
    {
        ...
        public static SqlDataAdapter ExecuteDataAdapter(string connectionString, CommandType commandType,
        ...
        public static DataTableReader ExecuteTableReader(string connectionString, CommandType commandType,
            string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0)
                throw new ArgumentNullException("connectionString");
